...
const Committee = () => {
  ...
  const nationalAdvisory: Member[] = [
    ...
    { name: "Dr. Sunita Varjani", title: "School of Engineering Jointly with School of Health Science and Technology,UPES, Dehradun \n Adjunct Professor, Korea University, Seoul, South Korea", initials: "SV", image: "/images/dignitaries/sunita.png", link: "https://www.linkedin.com/in/dr-sunita-varjani-puro-86295727/?originalSubdomain=hk" },
  ];
