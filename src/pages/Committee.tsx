...
const Committee = () => {
  usePageMeta({
    title: "Advisory Committee | GCESDIP 2.0 — SVNIT Surat",
    description:
      "International and national advisory committee members guiding GCESDIP 2.0, the green chemistry and engineering conference at SVNIT Surat.",
    path: "/committee",
  });
  ...
  const internationalAdvisory: Member[] = [
    ...
    { name: "Prof. Neeraj Rai", title: "Mississippi University, USA", initials: "NR", image: "/images/dignitaries/rai.png", link: "https://www.che.msstate.edu/people/faculty/neeraj-rai/" },
    ...
    { name: "Prof. Kenji Hara", title: "Tokyo University of Technology, Japan", initials: "KH", image: "/images/dignitaries/kenji.png", link: "https://www.teu.ac.jp/grad/english/teacher/es_spc/index.html?id=20" },
    ...
    { name: "Dr. Alexandar Knebel", title: "Friedrich Schiller University Jena, Germany", initials: "AK", image: "/images/dignitaries/knebel.png", link: "https://www.linkedin.com/in/alexander-knebel/?originalSubdomain=de" },
  ...
  const nationalAdvisory: Member[] = [
    { name: "Prof. K. K. Pant", title: "Director, IIT Roorkee", initials: "KP", image: "/images/dignitaries/pant.png", link: "https://web.iitd.ac.in/~kkpant/biosketch.html" }, 
    ...
    { name: "Dr. N. V. Choudhary", title: "CSIR-IICT Hyderabad", initials: "NC", image: "/images/dignitaries/nvc.png", link: "https://nvchoudary.com/" },
    { name: "Dr. S. Sridhar", title: "CSIR-IICT Hyderabad", initials: "SS", image: "/images/dignitaries/sridhar.png", link: "https://www.linkedin.com/in/dr-s-sridhar-iict-7601011/" },
    { name: "Prof. Parameswar K. Iyer", title: "IIT Guwahati", initials: "PI", image: "/images/dignitaries/iyer.png", link: "https://www.iitg.ac.in/chemistry/fac/pki/profile.html" },
    { name: "Prof. Yogendra Shastri", title: "IIT Bombay", initials: "YS", image: "/images/dignitaries/yogendra.png", link: "https://homepages.iitb.ac.in/~yshastri/Y%20Shastri_CV_Full.pdf" },
    { name: "Prof. (Retd.) Debapriya Mandal", title: "IIT Jammu", initials: "DM", image: "/images/dignitaries/mandal.png", link: "https://www.iitjammu.ac.in/post/prof-debapriya-mandal-wins-the-insa-visiting-scientist-programme-2024-25" },
    { name: "Prof. Chinmay Ghoroi", title: "IIT Gandhinagar", initials: "CG", image: "/images/dignitaries/chinmay.png", link: "https://iitgn.ac.in/faculty/chemical/fac-chinmay" },
    { name: "Prof. Parag R. Gogate", title: "ICT Mumbai", initials: "PG", image: "/images/dignitaries/parag.png", link: "https://www.ictmumbai.edu.in/emp_profiledetail.aspx?nDeptID=gq" },
    { name: "Dr. P. K. Rout", title: "CSIR-CIMAP Lucknow", initials: "PR", image: "/images/dignitaries/pk.png", link: "https://www.cimap.res.in/EmployeeProfile/EmployeeProfile.aspx?id=634" },
    { name: "Prof. Kailash Singh", title: "MNIT Jaipur", initials: "KS", image: "/images/dignitaries/kailash.png", link: "https://www.mnit.ac.in/dept_chemical/profile?fid=TK4=" },
    { name: "Prof. Shirish Sonawane", title: "NIT Warangal", initials: "SSo", image: "/images/dignitaries/sonawane.png", link: "https://erp.nitw.ac.in/ext/profile/ch-shirish" },
    { name: "Prof. Sachin Mandavgane", title: "VNIT Nagpur", initials: "SM", image: "/images/dignitaries/mandavgane.png", link: "https://vnit.ac.in/engineering/chemical/2023/06/05/dr-sachin-a-mandavgane/" },
    { name: "Prof. Sunita Varjani", title: "UPES, Dehradun; Korea University, Seoul, South Korea", initials: "SV", image: "/images/dignitaries/sunita.png", link: "https://www.linkedin.com/in/dr-sunita-varjani-puro-86295727/?originalSubdomain=hk" },
    { name: "Dr. Gaurav Sharma", title: "IIT Roorkee", initials: "GS", image: "/images/dignitaries/gaurav.png", link: "https://www.iitr.ac.in/~CH/goravfch" },
    { name: "Dr. Bharat Modhera", title: "MANIT Bhopal", initials: "BM", image: "/images/dignitaries/bharat.png", link: "https://cse.manit.ac.in/content/dr-bharatkumar-k-modhera" },
    { name: "Dr. Susmita Das", title: "NIT Calicut", initials: "SD", image: "/images/dignitaries/sushmita.png", link: "https://nitc.ac.in/department/chemical-engineering/faculty-and-staff/faculty/dccce194-e151-4e30-a2e1-f5b418b0357e" },
    { name: "Dr. Deepak Jain", title: "Zoetis Pharmaceutical Research Pvt. Ltd., Navi Mumbai", initials: "DJ", image: "/images/dignitaries/deepak.png", link: "https://www.linkedin.com/in/deepak-jain-7a407170/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
    ...
    { name: "Mr. Vipul Prajapati", title: "MYK Laticrete, Hyderabad", initials: "VP", image: "/images/dignitaries/vipul.png", link: "/images/prajapati.pdf" },
